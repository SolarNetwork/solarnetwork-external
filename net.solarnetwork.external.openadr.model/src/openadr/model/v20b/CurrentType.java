    ...
    implements Serializable, Equals2, HashCode2, ToString2
{
     ...
     * 
     */
    public CurrentType(final String itemDescription, final String itemUnits, final String siScaleCode) {
        super();
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final CurrentType that = ((CurrentType) object);
        {
    ...
    public CurrentType withItemDescription(String value) {
        setItemDescription(value);
        return this;
    }

    public CurrentType withItemUnits(String value) {
        setItemUnits(value);
        return this;
    }

    public CurrentType withSiScaleCode(String value) {
