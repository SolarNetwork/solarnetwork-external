...
public class SignatureProperties implements Serializable, Equals2, HashCode2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "signatureProperties", buffer, theSignatureProperties, ((this.signatureProperties!= null)&&(!this.signatureProperties.isEmpty())));
        }
        {
            String theId;
            theId = this.getId();
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, java.lang.Object object, EqualsStrategy2 strategy) {
        ...
        final SignatureProperties that = ((SignatureProperties) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "signatureProperties", lhsSignatureProperties), LocatorUtils.property(thatLocator, "signatureProperties", rhsSignatureProperties), lhsSignatureProperties, rhsSignatureProperties, ((this.signatureProperties!= null)&&(!this.signatureProperties.isEmpty())), ((that.signatureProperties!= null)&&(!that.signatureProperties.isEmpty())))) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            List<SignatureProperty> theSignatureProperties;
            theSignatureProperties = (((this.signatureProperties!= null)&&(!this.signatureProperties.isEmpty()))?this.getSignatureProperties():null);
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "signatureProperties", theSignatureProperties), currentHashCode, theSignatureProperties, ((this.signatureProperties!= null)&&(!this.signatureProperties.isEmpty())));
        }
        {
            String theId;
            theId = this.getId();
