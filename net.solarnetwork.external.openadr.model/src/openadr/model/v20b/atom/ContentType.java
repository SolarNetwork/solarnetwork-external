...
public class ContentType implements Serializable, Equals2, HashCode2, ToString2
{
     ...
     * 
     */
    public ContentType(final List<Object> content, final String type, final String src, final String base, final String lang, final Map<QName, String> otherAttributes) {
    ...
    public ContentType withType(String value) {
        setType(value);
        return this;
    }

    public ContentType withSrc(String value) {
        setSrc(value);
        return this;
    }

    public ContentType withBase(String value) {
        setBase(value);
        return this;
    }

    public ContentType withLang(String value) {
        setLang(value);
        return this;
    }
