...
public class DateTimeType implements Serializable, Equals2, HashCode2, ToString2
{
     ...
     * 
     */
    public DateTimeType(final XMLGregorianCalendar value, final String base, final String lang, final Map<QName, String> otherAttributes) {
        this.value = value;
        this.base = base;
        this.lang = lang;
    ...
    public DateTimeType withValue(XMLGregorianCalendar value) {
        setValue(value);
        return this;
    }

    public DateTimeType withBase(String value) {
        setBase(value);
        return this;
    }

    public DateTimeType withLang(String value) {
        setLang(value);
        return this;
    }
