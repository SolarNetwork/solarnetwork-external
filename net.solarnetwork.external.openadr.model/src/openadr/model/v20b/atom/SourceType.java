...
public class SourceType implements Serializable, Equals2, HashCode2, ToString2
{
     ...
     * 
     */
    public SourceType(final List<Object> authorsAndCategoriesAndContributors, final String base, final String lang, final Map<QName, String> otherAttributes) {
    ...
    public SourceType withAuthorsAndCategoriesAndContributors(Object... values) {
        if (values!= null) {
    ...
    public SourceType withAuthorsAndCategoriesAndContributors(Collection<Object> values) {
        if (values!= null) {
    ...
    public SourceType withBase(String value) {
        setBase(value);
        return this;
    }

    public SourceType withLang(String value) {
        setLang(value);
        return this;
    }
