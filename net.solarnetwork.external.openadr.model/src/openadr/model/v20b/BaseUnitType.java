    ...
    implements Serializable, Equals2, HashCode2, ToString2
{
     ...
     * 
     */
    public BaseUnitType(final String itemDescription, final String itemUnits, final String siScaleCode) {
        super();
    ...
    public BaseUnitType withItemDescription(String value) {
        setItemDescription(value);
        return this;
    }

    public BaseUnitType withItemUnits(String value) {
        setItemUnits(value);
        return this;
    }

    public BaseUnitType withSiScaleCode(String value) {
