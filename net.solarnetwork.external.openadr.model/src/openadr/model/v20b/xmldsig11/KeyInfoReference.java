...
@XmlRootElement(name = "KeyInfoReference")
public class KeyInfoReference implements Serializable, Equals2, HashCode2, ToString2
{
     ...
     * 
     */
    public KeyInfoReference(final String uri, final String id) {
        this.uri = uri;
        this.id = id;
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final KeyInfoReference that = ((KeyInfoReference) object);
        {
            String lhsURI;
            lhsURI = this.getURI();
            String rhsURI;
    ...
    public KeyInfoReference withURI(String value) {
        setURI(value);
        return this;
    }

    public KeyInfoReference withId(String value) {
        setId(value);
        return this;
    }
