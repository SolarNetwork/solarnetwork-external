    ...
    implements Serializable, Equals2, HashCode2, ToString2
{
     ...
     * 
     */
    public EnergyItemType(final String itemDescription, final String itemUnits, final String siScaleCode) {
        super();
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final EnergyItemType that = ((EnergyItemType) object);
        {
    ...
    public EnergyItemType withItemDescription(String value) {
        setItemDescription(value);
        return this;
    }

    public EnergyItemType withItemUnits(String value) {
        setItemUnits(value);
        return this;
    }

    public EnergyItemType withSiScaleCode(String value) {
