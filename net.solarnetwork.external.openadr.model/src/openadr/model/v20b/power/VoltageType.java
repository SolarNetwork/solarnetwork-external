    ...
    implements Serializable, Equals2, HashCode2, ToString2
{
     ...
     * 
     */
    public VoltageType(final String itemDescription, final String itemUnits, final String siScaleCode) {
        super();
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final VoltageType that = ((VoltageType) object);
        {
    ...
    public VoltageType withItemDescription(String value) {
        setItemDescription(value);
        return this;
    }

    public VoltageType withItemUnits(String value) {
        setItemUnits(value);
        return this;
    }

    public VoltageType withSiScaleCode(String value) {
