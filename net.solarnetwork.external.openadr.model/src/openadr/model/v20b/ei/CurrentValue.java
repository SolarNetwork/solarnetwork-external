...
public class CurrentValue implements Serializable, Equals2, HashCode2, ToString2
{
     ...
     * 
     */
    public CurrentValue(final PayloadFloatType payloadFloat) {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            PayloadFloatType thePayloadFloat;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            PayloadFloatType lhsPayloadFloat;
            lhsPayloadFloat = this.getPayloadFloat();
            PayloadFloatType rhsPayloadFloat;
    ...
    public CurrentValue withPayloadFloat(PayloadFloatType value) {
