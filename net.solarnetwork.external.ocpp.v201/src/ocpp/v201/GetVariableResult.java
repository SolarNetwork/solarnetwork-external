...
public class GetVariableResult implements Serializable
{
    ...
    private final static long serialVersionUID = -8567087027473762554L;
     ...
     * @param variable
     */
    public GetVariableResult(GetVariableStatusEnum attributeStatus, Component component, Variable variable) {
        super();
