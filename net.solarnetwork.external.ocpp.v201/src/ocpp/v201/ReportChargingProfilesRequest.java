...
public class ReportChargingProfilesRequest implements Serializable
{
    ...
    private final static long serialVersionUID = -8208303774108925481L;
     ...
     */
    public ReportChargingProfilesRequest(Integer requestId, ChargingLimitSourceEnum chargingLimitSource, List<ChargingProfile> chargingProfile, Integer evseId) {
        super();
