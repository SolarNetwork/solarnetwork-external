...
public class NotifyMonitoringReportRequest implements Serializable
{
    ...
    private final static long serialVersionUID = -6442696183180884205L;
     ...
     * @param generatedAt
     */
    public NotifyMonitoringReportRequest(Integer requestId, Integer seqNo, Instant generatedAt) {
        super();
    ...
    public NotifyMonitoringReportRequest withGeneratedAt(Instant generatedAt) {
        this.generatedAt = generatedAt;
        return this;
    }
