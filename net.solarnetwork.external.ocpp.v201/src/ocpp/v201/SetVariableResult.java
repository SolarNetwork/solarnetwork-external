...
public class SetVariableResult implements Serializable
{
    ...
    private final static long serialVersionUID = 8091111526006431233L;
     ...
     * @param variable
     */
    public SetVariableResult(SetVariableStatusEnum attributeStatus, Component component, Variable variable) {
        super();
