...
public class TransactionEventRequest implements Serializable
{
    ...
    private final static long serialVersionUID = -4268595858011227991L;
     ...
     */
    public TransactionEventRequest(TransactionEventEnum eventType, Instant timestamp, TriggerReasonEnum triggerReason, Integer seqNo, Transaction transactionInfo) {
        super();
    ...
    public TransactionEventRequest withTimestamp(Instant timestamp) {
        this.timestamp = timestamp;
        return this;
    }
