...
public class MeterValuesRequest implements Serializable
{
    ...
    private final static long serialVersionUID = 2718463700070296375L;
     ...
     * @param meterValue
     */
    public MeterValuesRequest(Integer evseId, List<MeterValue> meterValue) {
        super();
        this.evseId = evseId;
