...
public class SetNetworkProfileRequest implements Serializable
{
    ...
    private final static long serialVersionUID = 7891972973882900255L;
     ...
     */
    public SetNetworkProfileRequest(Integer configurationSlot, NetworkConnectionProfile connectionData) {
        super();
