...
public class IdTokenInfo implements Serializable
{
    ...
    private final static long serialVersionUID = -6388265954040311266L;
     ...
     */
    @JsonProperty("cacheExpiryDateTime")
    public void setCacheExpiryDateTime(Instant cacheExpiryDateTime) {
        this.cacheExpiryDateTime = cacheExpiryDateTime;
    }

    public IdTokenInfo withCacheExpiryDateTime(Instant cacheExpiryDateTime) {
        this.cacheExpiryDateTime = cacheExpiryDateTime;
        return this;
    }
