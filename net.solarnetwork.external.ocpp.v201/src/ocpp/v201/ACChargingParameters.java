...
public class ACChargingParameters implements Serializable
{
    ...
    private final static long serialVersionUID = -1300618184736356273L;
     ...
     * @param energyAmount
     */
    public ACChargingParameters(Integer energyAmount, Integer evMinCurrent, Integer evMaxCurrent, Integer evMaxVoltage) {
        super();
