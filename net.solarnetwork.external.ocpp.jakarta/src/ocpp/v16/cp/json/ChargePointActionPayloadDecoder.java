...
/**
 * OCPP 1.6 implementation of {@link ocpp.json.ActionPayloadDecoder} for Charge
 * Point actions.
 * 
 * @author matt
 * @version 1.0
...
public class ChargePointActionPayloadDecoder extends BaseActionPayloadDecoder {
	...
	private <T> void validateActionMessage(final ocpp.v16.ChargePointAction action,
			final boolean forResult, T obj) {
		JAXBElement<?> el = null;
		switch (action) {
			case CancelReservation:
				el = forResult
