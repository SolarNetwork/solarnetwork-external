...
public class ChargingSchedule implements Serializable
{
    ...
    private final static long serialVersionUID = 8337143508174244863L;
     ...
     * @param id
     */
    public ChargingSchedule(Integer id, ChargingRateUnitEnum chargingRateUnit, List<ChargingSchedulePeriod> chargingSchedulePeriod) {
        super();
        this.id = id;
     ...
     */
    @JsonProperty("startSchedule")
    public void setStartSchedule(Instant startSchedule) {
        this.startSchedule = startSchedule;
    }

    public ChargingSchedule withStartSchedule(Instant startSchedule) {
        this.startSchedule = startSchedule;
        return this;
    }
