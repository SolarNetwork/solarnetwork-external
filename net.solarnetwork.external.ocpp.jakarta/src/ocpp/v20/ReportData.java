...
public class ReportData implements Serializable
{
    ...
    private final static long serialVersionUID = 2470407373430786146L;
     ...
     * @param variable
     */
    public ReportData(Component component, Variable variable, List<VariableAttribute> variableAttribute) {
        super();
