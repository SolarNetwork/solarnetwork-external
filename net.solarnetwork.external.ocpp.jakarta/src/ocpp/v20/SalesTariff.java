...
public class SalesTariff implements Serializable
{
    ...
    private final static long serialVersionUID = 2866528591814338841L;
    ...
    /**
     * 
     * @param salesTariffEntry
     * @param id
     */
    public SalesTariff(Integer id, List<SalesTariffEntry> salesTariffEntry) {
        super();
        this.id = id;
