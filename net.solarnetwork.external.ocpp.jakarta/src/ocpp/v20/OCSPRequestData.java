...
public class OCSPRequestData implements Serializable
{
    ...
    private final static long serialVersionUID = -5047674187898183156L;
     ...
     * @param hashAlgorithm
     */
    public OCSPRequestData(HashAlgorithmEnum hashAlgorithm, String issuerNameHash, String issuerKeyHash, String serialNumber, String responderURL) {
        super();
