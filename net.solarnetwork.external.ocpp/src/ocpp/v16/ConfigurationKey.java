...
import static ocpp.domain.ConfigurationType.Boolean;
import static ocpp.domain.ConfigurationType.CSL;
import static ocpp.domain.ConfigurationType.Integer;
import static ocpp.v16.FeatureProfile.LocalAuthListManagement;
import static ocpp.v16.FeatureProfile.Reservation;
import static ocpp.v16.FeatureProfile.SmartCharging;
...
public enum ConfigurationKey implements ocpp.domain.ConfigurationKey {
	...
	/** A list of supported {@link ocpp.v16.FeatureProfile} values. */
