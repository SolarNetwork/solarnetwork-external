...
public class NotifyReportRequest implements Serializable
{
    ...
    private final static long serialVersionUID = -3953070101768026743L;
     ...
     * @param generatedAt
     */
    public NotifyReportRequest(Integer requestId, Instant generatedAt, Integer seqNo) {
        super();
    ...
    public NotifyReportRequest withGeneratedAt(Instant generatedAt) {
        this.generatedAt = generatedAt;
        return this;
    }
