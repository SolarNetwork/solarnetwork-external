...
public class Get15118EVCertificateRequest implements Serializable
{
    ...
    private final static long serialVersionUID = -544922301353476698L;
     ...
     * @param exiRequest
     */
    public Get15118EVCertificateRequest(String iso15118SchemaVersion, CertificateActionEnum action, String exiRequest) {
        super();
