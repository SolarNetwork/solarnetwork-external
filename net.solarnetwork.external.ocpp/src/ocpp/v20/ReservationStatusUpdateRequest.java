...
public class ReservationStatusUpdateRequest implements Serializable
{
    ...
    private final static long serialVersionUID = -3101933151001046338L;
     ...
     * 
     * @param reservationId
     * @param reservationUpdateStatus
     */
    public ReservationStatusUpdateRequest(Integer reservationId, ReservationUpdateStatusEnum reservationUpdateStatus) {
        super();
