...
public class NetworkConnectionProfile implements Serializable
{
    ...
    private VPN vpn;
    private final static long serialVersionUID = 3906440447025196295L;
     ...
     * @param ocppInterface
     */
    public NetworkConnectionProfile(OCPPVersionEnum ocppVersion, OCPPTransportEnum ocppTransport, String ocppCsmsUrl, Integer messageTimeout, Integer securityProfile, OCPPInterfaceEnum ocppInterface) {
        super();
