...
public abstract class AbstractTestHandler extends AbstractHandler {
	 ...
	 */
	protected void respondWithSoapBody(Writer out, String body) throws IOException {
		out.append("<?xml version=\"1.0\" ?><S:Envelope xmlns:S=\"http://www.w3.org/2003/05/soap-envelope\"><S:Body>");
		out.append(body);
